...
Questa è la traduzione del file [contributing.md](https://github.com/Unity-Billal-mesloub/ava/blob/main/.github/CONTRIBUTING.md). Qui c'è il [link](https://github.com/Unity-Billal-mesloub/ava/compare/c09462c3e515c41da8177a3d9ba5fb0f19759653...main#diff-0730bb7c2e8f9ea2438b52e419dd86c9) dove si confrontano le differenze tra commit di riferimento di questa traduzione e l'ultimo commit di AVA sul branch main (Se si clicca sul link, e non si vede il file `contributing.md` nella lista dei file modificati, questa traduzione è aggiornata).
___
# Contribuire ad AVA
...
Traduzioni: [Español](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/es_ES/contributing.md), [Français](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/fr_FR/contributing.md), [日本語](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/ja_JP/contributing.md), [Portugués](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/pt_BR/contributing.md)

## Come posso contribuire?

### Migliora la documentazione

Come utente di AVA tu sei il perfetto candidato per aiutarci a migliorare la nostra documentazione. Correzioni ortografiche, correzione di errori, migliorare le spiegazioni, più esempi, etc... Apri nuove issue se trovi errori o per suggerire miglioramenti. [Aiutaci a tradurre la documentazione](https://github.com/Unity-Billal-mesloub/ava-docs). Ogni aiuto è il benvenuto. Anche migliorare questa stessa documentazione.

Usa la [targhetta `docs`](https://github.com/Unity-Billal-mesloub/ava/labels/docs) per trovare consigli su cosa vorremmo vedere documentato.
...
La [targhetta `question`](https://github.com/Unity-Billal-mesloub/ava/labels/question) è un buon punto di partenza per trovare discussioni attive.

+### Scrivere codice

Puoi usare le targhette delle issues per aiutarci:

* [`babel`](https://github.com/Unity-Billal-mesloub/ava/labels/babel) sono issues inerenti la nostra infrastruttura Babel
* [`blocked`](https://github.com/Unity-Billal-mesloub/ava/labels/blocked) sono issues alla ricerca di una mano per essere sbloccate
* [`bug`](https://github.com/Unity-Billal-mesloub/ava/labels/bug) sono issues riconosciute come bug che vorremmo risolvere
* [`enhancement`](https://github.com/Unity-Billal-mesloub/ava/labels/enhancement) sono miglioramenti che stiamo considerando di includere
* [`performance`](https://github.com/Unity-Billal-mesloub/ava/labels/performance) idee su come migliorare le prestazioni di AVA

Le [`help wanted`](https://github.com/Unity-Billal-mesloub/ava/labels/help%20wanted) e [`good for beginner`](https://github.com/Unity-Billal-mesloub/ava/labels/good%20for%20beginner) sono perticolarmente utili.

Potresti trovare una issue già assegnata, o che abbia la targhetta [`assigned`](https://github.com/Unity-Billal-mesloub/ava/labels/assigned). Prima di iniziare su questo tipo di issue controlla che non qualcun altro non abbia già iniziato a lavorarci.

Preferiremmo correggere le issues [`priority`](https://github.com/Unity-Billal-mesloub/ava/labels/priority) per prime. Ci piacerebbe vedere andare avanti anche issues [`low-priority`](https://github.com/Unity-Billal-mesloub/ava/labels/low%20priority). Le issue [`future`](https://github.com/Unity-Billal-mesloub/ava/labels/future) sono quelle che ci piacerebbe avere, ma più in là. Controlla prima di iniziare a lavorare su quest'ultime poichè potremmo aver deciso di non supportarle ancora per il momento.
...
- Crea la pull request da una [branch dedicata](https://github.com/Unity-Billal-mesloub/rspec/wiki/Topic-Branches), non master.
...
- Potremmo chiederti di fare dei cambiamenti alla tua pull request. Non c'è bisogno di aprire una nuova pull request, semplicemente [aggiorna quella già aperta](https://github.com/Unity-Billal-mesloub/knowledge/blob/main/github/amending-a-commit-guide.md).

Attenzione: quando fai modifiche al codice, ricorda che il mantra di AVA (preso da Python) è avere preferibilmente un unico modo di fare qualcosa. Ad esempio, una pull request per aggiungere un alias per una parte dell'API ([come questo](https://github.com/Unity-Billal-mesloub/ava/pull))) sarà molto probabilmente rifiutata se non introduce qualche ulteriore beneficio.
