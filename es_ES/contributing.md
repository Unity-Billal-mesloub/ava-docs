...
Esta es la traducción del archivo [contributing.md](https://github.com/Unity-Billal-mesloub/ava/blob/main/.github/CONTRIBUTING.md). 

Aquí hay un [enlace](https://github.com/Unity-Billal-mesloub/ava/compare/4111f9483f2ff6a158b603735a712eee3ab074c4...main#diff-cc4aac3e9be04e0413c9520f223b493c) a las diferencias con la rama master de AVA (Si al hacer clic en el enlace no se encuentran modificaciones en el archivo `contributing.md`, será por que la traducción está actualizada).
___
# Contribuir a AVA
...
Traducciones: [Español](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/es_ES/contributing.md), [Français](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/fr_FR/contributing.md), [Italiano](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/it_IT/contributing.md), [日本語](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/ja_JP/contributing.md), [Portugués](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/pt_BR/contributing.md), [Русский](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/ru_RU/contributing.md), [简体中文](https://github.com/Unity-Billal-mesloub/ava-docs/blob/main/zh_CN/contributing.md)

## ¿Cómo puedo contribuir?

### Mejorar la documentación

Como usuario de AVA, usted es el candidato perfecto para ayudarnos a mejorar nuestra documentación. Correcciones tipográficas, correcciones de errores, mejores explicaciones, más ejemplos, etc. Cuestiones abiertas para las cosas que se podrían mejorar. [Ayudanos a traducir nuestros documentos.](https://github.com/Unity-Billal-mesloub/ava-docs) Cualquier cosa. Incluso las mejoras a este documento.

Usa la etiqueta [`docs`](https://github.com/Unity-Billal-mesloub/ava/labels/docs) para encontrar sugerencias sobre temas en los que nos encantaría tener más documentación.
...
La etiqueta [`question`](https://github.com/Unity-Billal-mesloub/ava/labels/question) es un buen punto de partida para encontrar discusiones abiertas.

### Escribiendo código

Puedes usar las etiquetas para descubrir las incidencias con las que puedes colaborar:

* [`babel` issues](https://github.com/Unity-Billal-mesloub/ava/labels/babel) relacionado con nuestra infraestructura Babel
* [`blocked` issues](https://github.com/Unity-Billal-mesloub/ava/labels/blocked) necesitan ayuda para destrancarse
* [`bug` issues](https://github.com/Unity-Billal-mesloub/ava/labels/bug) son errores conocidos que nos gustaría arreglar
* [`enhancement` issues](https://github.com/Unity-Billal-mesloub/ava/labels/enhancement) son funciones que estamos abiertos a incluir
* [`performance` issues](https://github.com/Unity-Billal-mesloub/ava/labels/performance) monitorean ideas sobre cómo mejorar el desempeño de AVA

Las etiquetas de [`help wanted`](https://github.com/Unity-Billal-mesloub/ava/labels/help%20wanted) y [`good for beginner`](https://github.com/Unity-Billal-mesloub/ava/labels/good%20for%20beginner) son especialmente útiles.

Puedes encontrar una incidencia ya asignada, o con la etiqueta [`assigned`](https://github.com/Unity-Billal-mesloub/ava/labels/assigned). Por favor chequear dos veces antes de comenzar a trabajar en esta incidencia porque es probable que ya haya alguien más trabajando en ello.

Nos gustaría corregir primero las inidencias con la etiqueta [`priority`](https://github.com/Unity-Billal-mesloub/ava/labels/priority). Nos encantaría ver progreso en las de [`low-priority`](https://github.com/Unity-Billal-mesloub/ava/labels/low%20priority) también. [`future` issues](https://github.com/Unity-Billal-mesloub/ava/labels/future) son aquéllas a las que nos gustaría llegar, pero no prontamente. Por favor chequear antes de trabajar en estas porque quizás aún no querramos tomarnos el trabajo de brindarle soporte a estas funcionalidades.
...
- Haga el pull request de una [rama con el asunto](https://github.com/Unity-Billal-mesloub/rspec/wiki/Topic-Branches), no master.
...
- Es posible que se le pida que haga cambios en su pull request. No es necesario solicitar otro pull request. [Únicamente actualice el que tiene.](https://github.com/Unity-Billal-mesloub/knowledge/blob/main/github/amending-a-commit-guide.md)

Nota: mientras realices cambios de código, trata de recordar el mantra de AVA (robado a Python) de tener preferentemente una manera de hacer algo. Por ejemplo, una petición para agregar un alias a una parte de la API ([como aquí](https://github.com/Unity-Billal-mesloub/ava/pull)) va a ser probablemente rechazada si no tiene algún otro beneficio substancial.
