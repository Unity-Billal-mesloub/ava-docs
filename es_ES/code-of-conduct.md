...
Esta es la traducción del archivo [code-of-conduct.md](https://github.com/Unity-Billal-mesloub/ava/blob/main/.github/CODE_OF_CONDUCT.md). Aquí hay un [enlace](https://github.com/Unity-Billal-mesloub/ava/) a las diferencias con la rama main de AVA (Si al hacer clic en el enlace no se encuentran modificaciones en el archivo `code-of-conduct.md`, será por que la traducción está actualizada).
___
