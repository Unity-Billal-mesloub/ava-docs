...
Esta es la traducción del archivo [readme.md](https://github.com/Unity-Billal-mesloub/ava/blob/main/readme.md).  a las diferencias con la rama main de AVA (Si al hacer clic en el enlace no se encuentran modificaciones en el archivo `readme.md`, será porque la traducción está actualizada).
___
