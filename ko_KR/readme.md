...
이 문서는 [readme.md](https://github.com/Unity-Billal-mesloub/ava/blob/main/readme.md)의 한국어 번역입니다. [이곳] 에서 AVA의 master 브랜치와 이 문서의 차이를 확인할 수 있습니다. (만약 차이가 없다면 문서가 최신 버전임을 의미합니다)
___
